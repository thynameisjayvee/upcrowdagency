...
Blog filter has a really simple and easy to use (user-friendly) interface, it is so easy to use for both beginner and expert users because you dont have to do anything, just install and activate the plugin. You can generate the shortcode and paste it where you want to show blog post filtering or post portfolio. It will automatically fetch all blog and categories itself.

Many options are available to configure color and button color, show/hide title, show/hide Details/Permalink/Gallery buttons etc.

= HOW TO USE THE EASIEST BLOG PLUGIN IN WORDPRESS =
...
* Too Easy - It can automatically fetch all blogs data, you dont have to do anything.
...
* Post Links - You dont have do anything it will auto conect with your single post pages.
* Blog Post Title - show image title / label grid blog posts images.
* Masonry Layout - This plugin is auto masonry.
* Blog Multi Colour For Filters - apply multiple colours for filters button
...
* [Blog Filter Premium Multiple Cloumn Layout](https://awplife.com/demo/blog-filter-premium/column-layout/ "Blog Filter Premium (Blog Post Grid Layout with filters)")
...
* [Blog Filter Premium With Second Variationfor Title, Date & Autor](https://awplife.com/demo/blog-filter-premium/second-veriation/ "Blog Filter Premium (Blog Post Image With Second Variationfor Title, Date & Autor )")
...
* You can change unlimited colours in the Blog Filter (blog post Portfolio), change title & description background colours, change title description color, also change the border color of images. 
...
* Enhancements: None,
* Bug Fix: None.
* Additional changes: Added settings link on plugins page,
...
* Tested with WordPress version 5.0.2
* Enhancements: None,
* Bug Fix: yes.
* Additional changes: None,
...
* Enhancements: None,
* Bug Fix: yes, CSS Issue fixed.
* Additional changes: Yes, Link modified.

= 0.0.8 =

* Enhancements: None,
* Bug Fix: None,
* Additional changes: Yes, 1. Added shortcode update Post Links. 2. contact us link added.
