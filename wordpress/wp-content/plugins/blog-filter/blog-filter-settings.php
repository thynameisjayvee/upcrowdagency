	...
	<div class="panel-body " style="padding-top:20px" id="BlogFilter-SettingsPags">
			...
			<section class="module module-headings">
				<div class="module-inner">
					...
					<div class="module-content collapse in" id="content-1">
						...
						<div class="module-content-inner ">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								<p><b><?php _e('How Much Words Show In Description', BF_TXTDM); ?></b></p>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right">
								<input type="number" id="blog_desc_words" name="blog_desc_words" value="25" style="width: -webkit-fill-available;" >
							</div>
						</div>
						<div class="module-content-inner">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<div class="module-inner">
					...
					<div class="module-content collapse in" id="content-1">
						...
						<div class="module-content-inner ">
							...
							<p><b><?php _e('Note: In free version you can use Only 4 Filters', BF_TXTDM); ?></b></p>
						</div>
					</div>
				</div>
			</section>
		...
		<div class="module-wrapper masonry-item col-lg-4 col-md-4 col-sm-12 col-xs-12" style="">
			<section class="module module-headings">
				<div class="module-inner">
					<div class="module-heading">
						<h3 class="module-title"><?php _e('Try Pro Version 3.2 ', BF_TXTDM); ?></h3>
					</div>
					<div class="module-content collapse in" id="content-1">
						<div class="module-content-inner title_setings">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
...
<div class="panel panel-info bf_pannel_bottom">
	<div class="panel-body eva-bottom-panel">
		<div class="col-md-6 text-left">
			...
			<h3 class="bf_footer_title"><?php _e('Blog Filter', BF_TXTDM); ?> <p style="display:inline;"><?php _e('Version - 1.0.5', BF_TXTDM); ?><p></h3>
			</div>
		</div>
