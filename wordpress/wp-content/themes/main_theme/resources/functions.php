...
add_image_size( 'big-thumbnail', '100%', 368, true);
...
function ajax_filterposts_handler() {
  ...
  $category = get_category_by_slug('testing');
  ...
  if ( $the_query->have_posts() ){
    foreach ($the_query->posts as $post) {
      $post->thumbnail = get_the_post_thumbnail($post->ID, 'thumbnail', array('width' => '100%', 'height' => '100%'));
